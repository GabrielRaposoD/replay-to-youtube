...
from utils.data import save_match_data, save_replay_script


class Scrapper(DataScrapper):
    def __init__(self) -> None:
        super().__init__()
        # URL
        self.__replay_file_dir = r'./data/replay'
        ...
        self.__mac_script_xpath = '//*[contains(concat( " ", @class, " " ), concat( " ", "runCode", " " ))]'
    ...
    def init_data_folder(self) -> None:
        ...
        replay_folder_path = data_folder_path + '/replay'
        if not os.path.exists(data_folder_path):
            os.makedirs(data_folder_path)
        if not os.path.exists(replay_folder_path):
            os.makedirs(replay_folder_path)
    ...
    def start_scrap(self) -> None:
        ...
        # Save Data
        teste = save_match_data(self.match_data)
        print(teste)
    ...
    def __download_match(self):
        ...
        if platform.system() == 'Windows':
            ...
            script = self.driver.find_element(
                By.XPATH, self.__mac_script_xpath)
            save_replay_script(script.text)
        sleep(2)
