...
class CreateThumbnail:
    def __init__(self, data_scrapper: DataScrapper, data: MatchData) -> None:
        ...
        self.lol_data = data
        self.__thumb_path = r'./data/thumb.png'
    ...
    def create_thumbnail(self):
        ...
        self.__create_html(
            ...
            img_url=f'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/{champion}_0.jpg',
            mvp=self.lol_data['mvp']['champion'],
            vs=self.lol_data['loser'],
            region=self.lol_data['region'],
            patch=self.lol_data['patch']
        )
        html_path = os.path.abspath('data/thumbnail.html')
    ...
    def __create_html(self, kda: str, mvp: str, vs: str, region: str, patch: str, img_url: str):
        HTML = """
<!DOCTYPE html>
<html>
    <head>
...
"""
        with open("./data/thumbnail.html", "w") as f:
            f.write(HTML)
